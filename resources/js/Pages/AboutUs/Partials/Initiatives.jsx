    ...
    return (
        <div>
            ...
            <div className=' pt-32  w-4/5 mx-auto  flex flex-col gap-5 pb-44 '>
                ...
                {/* Description */}
                <div className=' pt-12 w-4/5 lg:w-auto   mx-auto flex flex-col gap-5 '>
                    <p className='text-white lg:text-center tracking-wider text-md text-start px-2 lg:px-20 font-extralight'>Jemarwen Baldon as well as Rommin Callos (aka Arcee), Lamina Studios University Ambassador goes to every university and college in Albay, Philippines. Lamina Studios were invited in several IT-related seminars or workshops.</p>
                    <p className='text-white lg:text-center tracking-wider text-md text-start px-2 lg:px-20 font-extralight'>
