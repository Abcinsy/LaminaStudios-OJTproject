...
const Index = () => {
    ...
    return (
        <div className='bg-neutral-900   '>
            ...
            {/* What We Offer */}
            <div className=' pt-32 w-4/5 lg:w-auto   mx-auto flex flex-col gap-5 '>
                <h1 className='text-yellow-400 uppercase font-bold tracking-wide text-center text-5xl lg:text-7xl  '>What We Offer</h1>
                <p className=' text-white lg:text-center tracking-wider text-xl text-start lg:text-3xl px-2 lg:px-64 font-extralight '>We offer internship opportunities as well as free training and mentoring to both students and professionals. For further inquiry, you can contact us via our
                    <span >&nbsp;<a className=" text-yellow-400 underline" href="#">contact form.</a></span></p>
            </div>
